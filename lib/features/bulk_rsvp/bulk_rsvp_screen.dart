...
class _BulkRSVPScreenState extends State<BulkRSVPScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer2<ClubsProvider, ParticipationProvider>(
        builder: (context, clubsProvider, participationProvider, child) {
                    ...
                    delegate: SliverChildBuilderDelegate(
                      (context, index) {
                        ...
                        return SelectablePracticeCard(
                          practice: practice,
                          currentUserId: participationProvider.currentUserId,
              ...
              Positioned(
                ...
                child: SafeArea(
                  child: BulkRSVPActionPanel(
                    ...
                    isLoading: _isLoading || participationProvider.isBulkOperationInProgress,
                  ),
                ),
              ),
              
              // Bulk operation progress overlay
              if (participationProvider.isBulkOperationInProgress)
                Container(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            participationProvider.bulkOperationStatus ?? 'Processing...',
