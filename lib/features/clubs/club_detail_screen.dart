...
// ...existing code...
  ...
  /// Auto-scroll to reveal the TabBar; if already visible/pinned this is a no-op
  ...
  Widget _buildClubHeaderContent(BuildContext context) {
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(height: 0), // No padding above club name
      ...
      body: _showingBulkRSVP
          ...
          : NestedScrollView(
              headerSliverBuilder: (context, innerBoxIsScrolled) {
                return [
                  SliverToBoxAdapter(
                    child: _buildClubHeaderContent(context),
                  ),
                  SliverPersistentHeader(
                    ...
                    delegate: _StickyTabBarDelegate(
                      TabBar(
                        ...
                        onTap: (index) {
                          // Keep the gentle auto-scroll behavior
                          if (index == 0) {
        ...
        children: [
            ...
            RecurringPracticesWidget(
              ...
              onToggle: () {
                ...
                // Auto-scroll within About disabled while page scrolling is off
              },
            ),
